...
//let resposta = prompt(`Qual a linguagem que você mais gosta?`);
...
//let validacao = idade >= 18 ? `Maior de idade` : `Menor de idade`;

//console.log(`Pela idade informada a pessoa é ${validacao}.`);
...
// 10 - Crie uma variável "nota" e atribua um valor numérico a ela. Use if-else para determinar se a nota é maior ou 
//igual a 7 e exiba "Aprovado" ou "Reprovado" no console.
